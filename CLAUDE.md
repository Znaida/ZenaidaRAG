...
- **64 tests**, ~80% cobertura del núcleo. Embeddings multilingüe, `min_score=0.35`. Docker **no** verificado en local (sin Docker); se construye en CI. Telegram/Teams no verificados en vivo (sin bot token / sin Azure); lógica unit-testeada.
